$(function(){
	...
	var header = {
		...
		"rain": "It's gonna rain. Stay home",
	...
	var subtitles = {
		"blank": "",
		"rain": "Water comin' outta the damn sky. Whose idea was this shit?",
		"clouds": "But it might not.",
		"clear": "Rain is really unlikely today.",
		"snow": "I recommend not leaving the house until all this white shit is gone.",
	...
	function aboutPage(){
		if (previousPage === "about"){
			nText = "Like a Weather app, but more angry.";
